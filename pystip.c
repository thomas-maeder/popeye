...
static slice_structural_type highest_structural_type[max_nr_slices] =
{
  ...
  slice_structure_branch, /* STRefutationsWriter */
...
static stip_structure_visitor const reachable_slices_markers[] =
{
  ...
  &mark_reachable_slice, /* STRefutationsWriter */
...
static void leaf_insert_root(slice_index si, stip_structure_traversal *st)
{
...
static stip_structure_visitor const proxy_resolvers[] =
{
  ...
  &pipe_resolve_proxies,             /* STRefutationsWriter */
...
static void find_unique_goal_leaf(slice_index si, stip_structure_traversal *st)
{
 ...
 */
static void make_leaf_direct(slice_index si, stip_structure_traversal *st)
{
  TraceFunctionEntry(__func__);
  TraceFunctionParam("%u",si);
  TraceFunctionParamListEnd();
...
static stip_structure_visitor const leaves_direct_makers[] =
{
  &stip_traverse_structure_children,   /* STProxy */
  &stip_traverse_structure_children,   /* STAttackMove */
  &stip_traverse_structure_children,   /* STDefenseMove */
...
static void make_leaves_direct(slice_index si)
{
  ...
  stip_structure_traversal_init(&st,&leaves_direct_makers,0);
  stip_traverse_structure(si,&st);
...
static void append_direct_defense(slice_index si,stip_structure_traversal *st)
{
...

  {
    ...
    pipe_append(si,alloc_direct_defense(length,min_length,*new_proxy_to_goal));
  }
...
static stip_structure_visitor const to_quodlibet_transformers[] =
{
  ...
  &stip_traverse_structure_children,   /* STSelfCheckGuardSolvableFilter */
  &stip_traverse_structure_children,   /* STSelfCheckGuardRootDefenderFilter */
  &append_direct_defense,              /* STSelfCheckGuardAttackerFilter */
  &stip_traverse_structure_children,   /* STSelfCheckGuardDefenderFilter */
  &stip_traverse_structure_children,   /* STSelfCheckGuardHelpFilter */
  &stip_traverse_structure_children,   /* STSelfCheckGuardSeriesFilter */
  &stip_traverse_structure_children,   /* STDirectDefenseRootSolvableFilter */
  ...
  &stip_traverse_structure_children,   /* STReflexRootSolvableFilter */
  &stip_traverse_structure_children,   /* STReflexAttackerFilter */
  &transform_to_quodlibet_self_defense,/* STReflexDefenderFilter */
...
void transform_to_quodlibet(void)
{
  ...
  stip_structure_traversal_init(&st,&to_quodlibet_transformers,&towards_goal);
  stip_traverse_structure(root_slice,&st);
...
static stip_structure_visitor const to_postkey_play_reducers[] =
{
  ...
  &stip_traverse_structure_children,              /* STSelfCheckGuardRootSolvableFilter */
  &stip_traverse_structure_children,              /* STSelfCheckGuardSolvableFilter */
  &selfcheckguard_root_defender_filter_reduce_to_postkey_play, /* STSelfCheckGuardRootDefenderFilter */
  &stip_traverse_structure_children,              /* STSelfCheckGuardAttackerFilter */
  &stip_traverse_structure_children,              /* STSelfCheckGuardDefenderFilter */
  &stip_traverse_structure_children,              /* STSelfCheckGuardHelpFilter */
  &stip_traverse_structure_children,              /* STSelfCheckGuardSeriesFilter */
...
{
  &proxy_make_setplay_slice,                  /* STProxy */
  &stip_traverse_structure_children,          /* STAttackMove */
...
boolean stip_apply_setplay(void)
{
  ...
  stip_structure_traversal_init(&st,&setplay_makers,&prod);
  stip_traverse_structure(root_slice,&st);
...
static void leaf_ends_only_in(slice_index si, stip_structure_traversal *st)
{
...
static void slice_ends_in_one_of_leaf(slice_index si, stip_structure_traversal *st)
{
  goal_set const * const goals = st->param;
...
static stip_structure_visitor const exact_makers[] =
{
  ...
  &make_exact_branch,       /* STRefutationsWriter */
...
static stip_structure_visitor const starter_detectors[] =
{
  ...
  &pipe_detect_starter,              /* STRefutationsWriter */
  ...
  &pipe_detect_starter,              /* STSelfCheckGuardRootDefenderFilter */
...
static stip_structure_visitor const starter_imposers[] =
{
  ...
  &pipe_impose_starter,           /* STRefutationsWriter */
...
static stip_structure_visitor const traversers[] =
{
  ...
  &traverse_structure_pipe,         /* STRefutationsWriter */
  ...
  &traverse_structure_pipe,         /* STSelfCheckGuardRootDefenderFilter */
  ...
  &traverse_structure_branch_fork,  /* STDirectDefenseRootSolvableFilter */
  &traverse_structure_branch_fork,  /* STDirectDefense */
  &traverse_structure_reflex_guard, /* STReflexHelpFilter */
  &traverse_structure_reflex_guard, /* STReflexSeriesFilter */
  &traverse_structure_reflex_guard, /* STReflexRootSolvableFilter */
  ...
  &traverse_structure_pipe,         /* STKeepMatingGuardRootDefenderFilter */
...
void stip_traverse_moves_pipe(slice_index si, stip_move_traversal *st)
{
  ...
  stip_traverse_moves(slices[si].u.pipe.next,st);
