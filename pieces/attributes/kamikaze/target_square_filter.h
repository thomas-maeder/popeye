#if !defined(PIECES_KAMIKAZE_TARGET_SQUARE_FILTER_H)
#define PIECES_KAMIKAZE_TARGET_SQUARE_FILTER_H

#include "pyslice.h"

/* This module provides slice type STPiecesKamikazeTargetSquareFilter - tests
