...
static slice_index const slice_rank_order[] =
{
  ...
  STCastlingChessHaanPartnerSquareBlocker,
  STCastlingChessKingSquareAdjuster,
  STHaanChessDepartureBlocker,
  ...
  STCastlingRightsRemover,
  STLosingChessCastlingRightsRemover,
  STAndernachCastlingRightsRestorer,
  STAntiAndernachCastlingRightsRestorer,
  STChameleonPursuitCastlingRightsRestorer,
  STNorskCastlingRightsRestorer,
  STProteanCastlingRightsRestorer,
  ...
  STKingAssassinationAvoider,
  STKingCaptureAvoider,
