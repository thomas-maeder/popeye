#if !defined(STIPULATION_GOALS_DOUBLEMATE_HELP_FILTER_H)
#define STIPULATION_GOALS_DOUBLEMATE_HELP_FILTER_H

#include "pystip.h"

/* This module provides functionality dealing with STDoubleMateHelpFilter
 * stipulation slices.
