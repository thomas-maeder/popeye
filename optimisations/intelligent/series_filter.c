 ...
 */
boolean intelligent_series_filter_solve_in_n(slice_index si, stip_length_type n)
{
  boolean result;
  ...
  result = IntelligentSeries(slices[si].u.pipe.next,n);
 ...
 */
boolean intelligent_series_filter_has_solution_in_n(slice_index si,
                                                    stip_length_type n)
{
