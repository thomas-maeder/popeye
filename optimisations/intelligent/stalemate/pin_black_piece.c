 ...
 */
static boolean pin_by_officer(unsigned int nr_remaining_black_moves,
...
/* @return true iff a pin was actually placed
 */
static boolean pin_by_promoted_pawn(unsigned int nr_remaining_black_moves,
                                    unsigned int nr_remaining_white_moves,
                                    unsigned int max_nr_allowed_captures_by_black_pieces,
                                    unsigned int max_nr_allowed_captures_by_white_pieces,
                                    stip_length_type n,
                                    ...
                                    boolean diagonal)
{
  ...
  if (pin_by_officer(nr_remaining_black_moves,
 ...
 */
static boolean pin_specific_piece_on(unsigned int nr_remaining_black_moves,
                                     unsigned int nr_remaining_white_moves,
                                     unsigned int max_nr_allowed_captures_by_black_pieces,
                                     unsigned int max_nr_allowed_captures_by_white_pieces,
                                     stip_length_type n,
                                     ...
                                     boolean diagonal)
{
  ...
  switch (pinner_type)
  {
    ...
    case tb:
      if (!diagonal
          && pin_by_officer(nr_remaining_black_moves,
                            nr_remaining_white_moves,
                            max_nr_allowed_captures_by_black_pieces,
                            max_nr_allowed_captures_by_white_pieces,
                            n,
    ...
    case pb:
      if (pin_by_promoted_pawn(nr_remaining_black_moves,
                               nr_remaining_white_moves,
                               max_nr_allowed_captures_by_black_pieces,
                               max_nr_allowed_captures_by_white_pieces,
                               n,
...
/* @return true iff >=1 pin was actually placed
 */
static boolean pin_specific_piece(unsigned int nr_remaining_black_moves,
                                  unsigned int nr_remaining_white_moves,
                                  unsigned int max_nr_allowed_captures_by_black_pieces,
                                  unsigned int max_nr_allowed_captures_by_white_pieces,
                                  stip_length_type n,
      ...
      if (nr_reasons_for_staying_empty[pin_on]==0)
      {
        ...
        for (pinner_index = 1; pinner_index<MaxPiece[White]; ++pinner_index)
        {
          if (white[pinner_index].usage==piece_is_unused)
          {
            ...
            if (pin_specific_piece_on(nr_remaining_black_moves,
                                      nr_remaining_white_moves,
                                      max_nr_allowed_captures_by_black_pieces,
                                      max_nr_allowed_captures_by_white_pieces,
                                      n,
                                                                      ...
                                                                      immobilisation_state_type const *state)
{
  ...
  for (i = 0; i!=state->nr_of_trouble_makers; ++i)
  {
    ...
    if (pin_specific_piece(nr_remaining_black_moves,
                           nr_remaining_white_moves,
                           max_nr_allowed_captures_by_black_pieces,
                           max_nr_allowed_captures_by_white_pieces,
                           n,
