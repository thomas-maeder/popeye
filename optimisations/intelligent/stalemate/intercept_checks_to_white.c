                               ...
                               unsigned int nr_checks_to_black)
{
  ...
  if (!(king_square[White]!=initsquare
        && officer_guards(king_square[White],blocker_type,where_to_intercept))
                               ...
                               unsigned int nr_checks_to_black)
{
  ...
  if (!officer_uninterceptably_attacks_king(Black,where_to_intercept,blocker_type)
      && intelligent_reserve_officer_moves_from_to(white[blocker_index].diagram_square,
                                                   ...
                                                   blocker_type))
  {
    if (officer_guards(king_square[Black],blocker_type,where_to_intercept))
      ++nr_checks_to_black;
                       ...
                       unsigned int nr_checks_to_black)
{
  ...
  for (where_to_intercept = king_square[White]+current_dir;
       e[where_to_intercept]==vide;
