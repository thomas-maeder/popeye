...
stip_length_type priorise_retraction_solve(slice_index si, stip_length_type n)
{
  stip_length_type result;
  ply const parent = parent_ply[nbply];
  square const sq_arrival = move_generation_stack[current_move[parent]].arrival;
  ...
  {
    square const sq_departure = move_generation_stack[current_move[parent]].departure;
    numecoup i;
