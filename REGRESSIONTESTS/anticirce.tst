...
similarities between Take&Make and Anticirce Take&Make
...
difference between Take&Make and Anticirce Take&Make
...
+---a---b---c---d---e---f---g---h---+
  ...
  1.a6*b7[wPb7->c8=Q->v]   2.Rc8-f8[+wQc8] z
...
+---a---b---c---d---e---f---g---h---+
  x1                          1 + 1
   ...
   1.c7*d8=Q[wfQd8->d8] x !

   1.c7*d8=S[wfSd8->d8] x !

   1.c7*d8=R[wfRd8->d8] x !
