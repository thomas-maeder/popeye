...
char const *MessageTabs[LanguageCount][MsgCount] =
{
  /*0*/ {
    ...
    /*76*/  "Termination par signal %d apres ",
    ...
    /*88*/  "%lu positions possibles dans %u+%u",
    /*89*/  "Melange interdit",
  ...
  /*1*/ {
    ...
    /*76*/  "Abbruch durch Signal %d nach ",
    ...
    /*88*/  "%lu moegliche Stellungen in %u+%u",
  ...
  /*2*/ {
    ...
    /*88*/  "%lu potential positions in %u+%u",
