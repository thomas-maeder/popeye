...
static char const *MessageTabs[LanguageCount][MsgCount] =
{
  /*0*/ {
    ...
    /*130*/ "Verification partie justificatives orthodoxes desactivee a cause d'un element feerique non-verifie\n"
  },
  /*1*/ {
    /* 0*/  "Fataler Fehler:\n",
    ...
    /*130*/ "Orthodoxe Pruefung von Beweispartien deaktiviert aufgrund eines unverifzierten Maerchenelements\n"
  },
  /*2*/ {
    /* 0*/  "fatal error:\n",
    ...
    /*130*/ "Orthodox proof game verification deactivated because of an unverified fairy element\n"
  }
};
