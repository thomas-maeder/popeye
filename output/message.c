...
static char const *MessageTabs[LanguageCount][MsgCount] =
{
  /*0*/ {
    ...
    /*17*/  "le camp au trait peut prendre le roi",
    ...
    /*77*/  "Une piece est deplacee hors de l'echiquier.",
  ...
  /*1*/ {
    ...
    /*17*/  "Die am Zug befindliche Partei kann den Koenig schlagen",
    ...
    /*77*/  "Ein Stein wird ueber den Brettrand verschoben.",
  ...
  /*2*/ {
    ...
    /*17*/  "the side to play can capture the king",
    ...
    /*77*/  "A piece will be moved outside.",
