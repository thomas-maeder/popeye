 ...
 */
stip_length_type
circe_steingewinn_filter_defend_in_n(slice_index si,
                                     stip_length_type n,
 ...
 */
stip_length_type
circe_steingewinn_filter_can_defend_in_n(slice_index si,
                                         stip_length_type n,
                                         stip_length_type n_max_unsolvable)
{
  stip_length_type result;
 ...
 */
stip_length_type
circe_steingewinn_filter_solve_in_n(slice_index si,
                                    stip_length_type n,
                                    stip_length_type n_max_unsolvable)
{
  stip_length_type result;
 ...
 */
stip_length_type
circe_steingewinn_filter_has_solution_in_n(slice_index si,
                                           stip_length_type n,
                                           stip_length_type n_max_unsolvable)
{
  stip_length_type result;
