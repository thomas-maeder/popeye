 ...
 */
void circe_steingewinn_filter_solve(slice_index si)
{
  TraceFunctionEntry(__func__);
  ...
  pipe_this_move_doesnt_solve_if(si,
                                 circe_find_current_rebirth()
                                 >=move_effect_journal_base[nbply]+move_effect_journal_index_offset_other_effects);
