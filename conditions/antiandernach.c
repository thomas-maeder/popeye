 ...
 *            n+2 no solution found
 */
stip_length_type antiandernach_castling_rights_restorer_attack(slice_index si,
                                                               stip_length_type n)
{
  stip_length_type result;
 ...
 *         n+2 refuted - >acceptable number of refutations found
 */
stip_length_type antiandernach_castling_rights_restorer_defend(slice_index si,
                                                               stip_length_type n)
{
  stip_length_type result;
...
void stip_insert_antiandernach(slice_index si)
{
  ...
  if (castling_supported)
    stip_instrument_moves_no_replay(si,STAntiAndernachCastlingRightsRestorer);
