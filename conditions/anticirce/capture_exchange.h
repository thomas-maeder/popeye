#if !defined(CONDITIONS_ANTICIRCE_CAPTURE_EXCHANGE_H)
#define CONDITIONS_ANTICIRCE_CAPTURE_EXCHANGE_H

/* This module implements regular Anticirce Capture&Exchange
 */
