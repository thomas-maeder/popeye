...
boolean antiguards_validate_observation(slice_index si)
{
  ...
  result = (is_target_guarded(CURRMOVE_OF_PLY(nbply))
...
void antiguards_remove_illegal_captures_solve(slice_index si)
{
  ...
  move_generator_filter_captures(MOVEBASE_OF_PLY(nbply),&is_target_guarded);
...
static void insert_remover(slice_index si, stip_structure_traversal *st)
{
  ...
  {
    slice_index const prototype = alloc_pipe(STAntiguardsRemoveIllegalCaptures);
...
void antiguards_initialise_solving(slice_index si)
{
  ...
  stip_instrument_observation_validation(si,nr_sides,STAntiguardsRemoveIllegalCaptures);
  stip_instrument_check_validation(si,nr_sides,STAntiguardsRemoveIllegalCaptures);
