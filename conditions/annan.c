...
void annan_initialise_solving(slice_index si)
{
  ...
  solving_instrument_moves_for_piece_generation(si,nr_sides,STAnnanMovesForPieceGenerator);
...
void nanna_initialise_solving(slice_index si)
{
  ...
  solving_instrument_moves_for_piece_generation(si,nr_sides,STNannaMovesForPieceGenerator);
