 ...
 */
stip_length_type antimars_en_passant_adjuster_attack(slice_index si,
                                                     stip_length_type n)
{
 ...
 */
stip_length_type antimars_en_passant_adjuster_defend(slice_index si,
                                                     stip_length_type n)
{
  stip_length_type result;
...
void stip_insert_antimars_en_passant_adjusters(slice_index si)
{
  ...
  stip_instrument_moves_no_replay(si,STAntiMarsCirceEnPassantAdjuster);
